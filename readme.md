...
This version of the text assumes you’re using **_Rust 1.85.0 (released 2025-02-17_**) or later with edition = "2024" in the
Cargo.toml file of all projects to configure them to use Rust 2024 edition idioms.

**Note -** The codes in this repository was built with **_Rust 1.90.0_**
